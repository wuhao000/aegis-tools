...
function createPropsMarkdown(component, resolveProps) {
 ...
 * @return {Array}
 */
function resolveExistsProps(mdFilePath) {
...
exports.default = resolveExistsProps;
